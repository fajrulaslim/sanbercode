...
<div class="row ctc_show_hide_display show-hide_display-none hidebased">
    <div class="input-field col s7">
        <input name="<?php echo $dbrow ?>[list_hideon_pages]" value="<?php echo esc_attr( $options['list_hideon_pages'] ) ?>" id="ccw_list_id_tohide" type="text" class="input-margin">
...
<div class="row ctc_show_hide_display show-hide_display-none hidebased">
    <div class="input-field col s7">
        <input name="<?php echo $dbrow ?>[list_hideon_cat]" value="<?php echo esc_attr( $options['list_hideon_cat'] ) ?>" id="ccw_list_cat_tohide" type="text" class="input-margin">
...
<div class="row ctc_show_hide_display show-hide_display-none showbased">
    <div class="input-field col s7">
        <input name="<?php echo $dbrow ?>[list_showon_pages]" value="<?php echo esc_attr( $options['list_showon_pages'] ) ?>" id="ccw_list_id_toshow" type="text" class="input-margin">
...
<div class="row ctc_show_hide_display show-hide_display-none showbased">
    <div class="input-field col s7">
        <input name="<?php echo $dbrow ?>[list_showon_cat]" value="<?php echo esc_attr( $options['list_showon_cat'] ) ?>" id="ccw_list_cat_toshow" type="text" class="input-margin">
